...
<script>
	...
	import empty from "@/components/custom-components/empty.vue";
	import Json from '@/request/Json.js';
	export default {
		components: {
			uniLoadMore,
			empty
		...
		.i-top{
			...
			.del-btn{
				...
				&:after{
					...
					width: 0;
					height: 30rpx;
					border-left: 1px solid $uni-text-color;
					position: absolute;
					left: 20rpx;
					top: 50%;
